...
//  Smartime
//
//  Created by Ricardo Pereira on 13/06/2015.
...
public class StyleKit : NSObject {
    ...
    public class func drawAbout(#frame: CGRect) {
        ...
        //// Color Declarations
        let transparent = UIColor(red: 1.000, green: 1.000, blue: 1.000, alpha: 0.000)
        let rogeBlue = UIColor(red: 0.384, green: 0.276, blue: 0.688, alpha: 0.856)

        //// Gradient Declarations
        let rogeBlueGradient = CGGradientCreateWithColors(CGColorSpaceCreateDeviceRGB(), [rogeBlue.CGColor, rogeBlue.blendedColorWithFraction(0.5, ofColor: transparent).CGColor, transparent.CGColor], [0, 0.53, 1])
        ...
        //// RectangleBase Drawing
        let rectangleBasePath = UIBezierPath(rect: CGRectMake(frame.minX, frame.minY, frame.width, frame.height))
        CGContextSaveGState(context)
        rectangleBasePath.addClip()
        let rectangleBaseRotatedPath = UIBezierPath()
        rectangleBaseRotatedPath.appendPath(rectangleBasePath)
        var rectangleBaseTransform = CGAffineTransformMakeRotation(-135*(-CGFloat(M_PI)/180))
        rectangleBaseRotatedPath.applyTransform(rectangleBaseTransform)
        var rectangleBaseBounds = CGPathGetPathBoundingBox(rectangleBaseRotatedPath.CGPath)
        rectangleBaseTransform = CGAffineTransformInvert(rectangleBaseTransform)

        CGContextDrawLinearGradient(context, rogeBlueGradient,
            CGPointApplyAffineTransform(CGPointMake(rectangleBaseBounds.minX, rectangleBaseBounds.midY), rectangleBaseTransform),
            CGPointApplyAffineTransform(CGPointMake(rectangleBaseBounds.maxX, rectangleBaseBounds.midY), rectangleBaseTransform),
            0)
        CGContextRestoreGState(context)
    }
    ...
    public class func drawMain(#frame: CGRect) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()
        ...
        //// BezierBase Drawing
        var bezierBasePath = UIBezierPath()
        bezierBasePath.moveToPoint(CGPointMake(frame.minX + 1.00000 * frame.width, frame.minY + 1.00000 * frame.height))
        bezierBasePath.addLineToPoint(CGPointMake(frame.minX + 0.00107 * frame.width, frame.minY + 1.00000 * frame.height))
        bezierBasePath.addCurveToPoint(CGPointMake(frame.minX + -0.00000 * frame.width, frame.minY + 0.92920 * frame.height), controlPoint1: CGPointMake(frame.minX + 0.00107 * frame.width, frame.minY + 1.00000 * frame.height), controlPoint2: CGPointMake(frame.minX + 0.00054 * frame.width, frame.minY + 0.98063 * frame.height))
        bezierBasePath.addCurveToPoint(CGPointMake(frame.minX + 0.00000 * frame.width, frame.minY + 0.29699 * frame.height), controlPoint1: CGPointMake(frame.minX + -0.00000 * frame.width, frame.minY + 0.79847 * frame.height), controlPoint2: CGPointMake(frame.minX + 0.00000 * frame.width, frame.minY + 0.51685 * frame.height))
        bezierBasePath.addCurveToPoint(CGPointMake(frame.minX + 0.00107 * frame.width, frame.minY + 0.12303 * frame.height), controlPoint1: CGPointMake(frame.minX + 0.00029 * frame.width, frame.minY + 0.24294 * frame.height), controlPoint2: CGPointMake(frame.minX + 0.00064 * frame.width, frame.minY + 0.18503 * frame.height))
        bezierBasePath.addCurveToPoint(CGPointMake(frame.minX + 1.00000 * frame.width, frame.minY + 0.00081 * frame.height), controlPoint1: CGPointMake(frame.minX + 0.00107 * frame.width, frame.minY + 0.12303 * frame.height), controlPoint2: CGPointMake(frame.minX + 0.95749 * frame.width, frame.minY + 0.00601 * frame.height))
        bezierBasePath.addCurveToPoint(CGPointMake(frame.minX + 1.00000 * frame.width, frame.minY + 1.00000 * frame.height), controlPoint1: CGPointMake(frame.minX + 1.00000 * frame.width, frame.minY + 0.07310 * frame.height), controlPoint2: CGPointMake(frame.minX + 1.00000 * frame.width, frame.minY + 0.95374 * frame.height))
        bezierBasePath.closePath()
        CGContextSaveGState(context)
        bezierBasePath.addClip()
        let bezierBaseBounds = CGPathGetPathBoundingBox(bezierBasePath.CGPath)
        CGContextDrawLinearGradient(context, StyleKit.softBlueGradient,
            CGPointMake(bezierBaseBounds.maxX, bezierBaseBounds.midY),
            CGPointMake(bezierBaseBounds.minX, bezierBaseBounds.midY),
            0)
        CGContextRestoreGState(context)
        ...
        bezierPath.moveToPoint(CGPointMake(frame.minX + 1.00000 * frame.width, frame.minY + 1.00000 * frame.height))
        bezierPath.addLineToPoint(CGPointMake(frame.minX + 0.00107 * frame.width, frame.minY + 1.00000 * frame.height))
        bezierPath.addCurveToPoint(CGPointMake(frame.minX + -0.00000 * frame.width, frame.minY + 0.92920 * frame.height), controlPoint1: CGPointMake(frame.minX + 0.00107 * frame.width, frame.minY + 1.00000 * frame.height), controlPoint2: CGPointMake(frame.minX + 0.00054 * frame.width, frame.minY + 0.98063 * frame.height))
        bezierPath.addCurveToPoint(CGPointMake(frame.minX + 0.00000 * frame.width, frame.minY + 0.29699 * frame.height), controlPoint1: CGPointMake(frame.minX + -0.00000 * frame.width, frame.minY + 0.79847 * frame.height), controlPoint2: CGPointMake(frame.minX + 0.00000 * frame.width, frame.minY + 0.51685 * frame.height))
        bezierPath.addCurveToPoint(CGPointMake(frame.minX + 0.00107 * frame.width, frame.minY + 0.12303 * frame.height), controlPoint1: CGPointMake(frame.minX + 0.00029 * frame.width, frame.minY + 0.24294 * frame.height), controlPoint2: CGPointMake(frame.minX + 0.00064 * frame.width, frame.minY + 0.18503 * frame.height))
        bezierPath.addCurveToPoint(CGPointMake(frame.minX + 1.00000 * frame.width, frame.minY + 0.00081 * frame.height), controlPoint1: CGPointMake(frame.minX + 0.00107 * frame.width, frame.minY + 0.12303 * frame.height), controlPoint2: CGPointMake(frame.minX + 0.95749 * frame.width, frame.minY + 0.00601 * frame.height))
        bezierPath.addCurveToPoint(CGPointMake(frame.minX + 1.00000 * frame.width, frame.minY + 1.00000 * frame.height), controlPoint1: CGPointMake(frame.minX + 1.00000 * frame.width, frame.minY + 0.07310 * frame.height), controlPoint2: CGPointMake(frame.minX + 1.00000 * frame.width, frame.minY + 0.95374 * frame.height))
        bezierPath.closePath()
        CGContextSaveGState(context)
        bezierPath.addClip()
        let bezierRotatedPath = UIBezierPath()
        bezierRotatedPath.appendPath(bezierPath)
        var bezierTransform = CGAffineTransformMakeRotation(-126*(-CGFloat(M_PI)/180))
        bezierRotatedPath.applyTransform(bezierTransform)
        var bezierBounds = CGPathGetPathBoundingBox(bezierRotatedPath.CGPath)
        bezierTransform = CGAffineTransformInvert(bezierTransform)

        CGContextDrawLinearGradient(context, rogeBlueGradient,
            CGPointApplyAffineTransform(CGPointMake(bezierBounds.minX, bezierBounds.midY), bezierTransform),
            CGPointApplyAffineTransform(CGPointMake(bezierBounds.maxX, bezierBounds.midY), bezierTransform),
            0)
        CGContextRestoreGState(context)
    }
